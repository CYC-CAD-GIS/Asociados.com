...
lyr_ESRISatelite_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_PaisesdelMundo_2.setVisible(true);lyr_Zonas_3.setVisible(true);lyr_MARAVILLASDELMUNDOANTIGUO_4.setVisible(true);
var layersList = [lyr_ESRISatelite_0,lyr_GoogleSatellite_1,lyr_PaisesdelMundo_2,lyr_Zonas_3,lyr_MARAVILLASDELMUNDOANTIGUO_4];
